...
class Assets_class {
     ...
     * @return  string
     **/
    protected function get_links($type, $assets, $combine, $minify, $media = NULL)
    {
        if ( ! $combine && ! $minify)
        {
     ...
     * @return    string
     **/
    protected function get_raw_links($type, $assets, $media)
    {
        $output = '';
     ...
     * @return    string
     **/
    protected function get_combined_link($type, $assets, $media)
    {
     ...
     * @return    string
     **/
    protected function get_minified_links($type, $assets, $media)
    {
        $output = '';
        foreach ($assets as $a)
        {
     ...
     * @return    string
     **/
    protected function get_combined_minified_link($type, $assets, $media)
    {
     ...
     * @return  string
     **/
    protected function get_minified_path($type, $path)
    {   
     ...
     * @return  string
     **/
    protected function get_cache_filename($type, $assets)
    { 
        if ( ! $this->auto_update)
        {
     ...
     * @return  void
     **/
    protected function update_cache($assets, $filename)
    {
     ...
     * @return  string
     **/
    protected function get_last_modified($type, $assets)
    {
        $timestamp = 0;
        foreach ($assets as $a)
        {
     ...
     * @return  array
     **/
    protected function get_config_options($config)
    {
        $options = array(
     ...
     * @return    string
     **/
    protected function tag($type, $path, $cache = FALSE, $media = NULL)
    {
        $output = '';
