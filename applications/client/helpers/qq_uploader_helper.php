...
*/
    ...
    function getName() {
        ...
        return (isset($_GET['qqFile'])) ? $_GET['qqFile'] : $_GET['qqfile'];
    }
    function getSize() {
...
*/
    function save($path) {
		...
		{			
			var_dump(is_uploaded_file($_FILES['qqfile']['tmp_name']));
...
class qqFileUploader {
    ...
    function __construct(array $allowedExtensions = array(), $sizeLimit = 10485760, $qqfile = ''){
